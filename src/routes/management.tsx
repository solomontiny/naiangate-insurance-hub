          ...
          {visible.map((m) => (
            ...
            >
              ...
              >
                ...
                <div className="relative aspect-[4/5] overflow-hidden rounded-2xl bg-secondary/30 ring-1 ring-black/10 shadow-[inset_0_0_0_2px_rgba(255,255,255,0.7),0_10px_28px_-14px_rgba(0,0,0,0.5)]">
                  <img
                    src={m.photo}
